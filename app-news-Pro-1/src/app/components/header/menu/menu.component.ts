...
export class MenuComponent implements OnInit {
  ...
  getDisplay(title: string) {
    if (
      title == 'EURO 2020' ||
      title == 'SĂN TOUR' ||
      title == 'CẨM NANG TUYỂN SINH 2021'
    )
      return 'block';
    return 'none';
  }
  setDataTM(urls: string) {
    this.menu.getData(urls).subscribe((value: any) => {
      for (let item of value['items']) {
        this.dataTM.push({
          title: item['title'],
          time: item['pubDate'].substr(11, 5),
          link: item['link'],
        });
      }
    });
  ...
  setColor(index: any) {
    ...
    this.displayCM1 = 'block';
    this.displayCM2 = 'none';
    this.displayTI1 = 'block';
    this.displayTI2 = 'none';
    this.displayVL1 = 'block';
    this.displayVL2 = 'none';
    this.displayTK1 = 'block';
    this.displayTK2 = 'none';
    this.displayLH1 = 'block';
    this.displayLH2 = 'none';
    this.displayTM1 = 'block';
    this.displayTM2 = 'none';
    this.displayTE1 = 'block';
    this.displayTE2 = 'none';
    ...
    if (index == 'lienhe') {
      ...
      this.indLH++;
      this.displayLH2 = 'block';
      this.displayLH1 = 'none';
